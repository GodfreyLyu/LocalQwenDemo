...
Audience: maintainers. Purpose: maintain the pinned inference contract. Prerequisites: basic familiarity with the root README; no running environment required.
